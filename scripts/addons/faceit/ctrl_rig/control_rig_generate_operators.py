...
class FACEIT_OT_GenerateControlRig(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        ctrl_utils.populate_control_rig_target_shapes_from_scene(ctrl_rig, populate_amplify_values=True, range=self.slider_range)
        if self.slider_range == 'POS':
            ...
            if self.auto_min_range:
                ...
                all_target_shapes = get_all_set_target_shapes(ctrl_rig.faceit_crig_targets)
