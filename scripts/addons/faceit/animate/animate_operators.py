                ...
                if self.is_new_rigify_rig:
                    ...
                    if 'lip_end.R' in bone_name:
                        ...
                        if bone_name in rig.pose.bones:
                            ...
                            dp = dp.replace(bone_name, bone.name)
                            bone_name = bone.name
                elif bone_name not in missing_dps:
        ...
        if self.scale_method == 'AUTO':
            ...
            if not bone_dimensions_check:
                ...
                if zero_dims:
                    ...
                    import_rig_dimensions[import_rig_dimensions.index(0)] = sum(import_rig_dimensions) / (3 - zero_dims)
                    self.report({'WARNING'}, f"Automatic Scaling Problem. Found {zero_dims} dimensions with 0. Filled with average of the other dimensions.")
