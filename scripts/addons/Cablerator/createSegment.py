...
class OBJECT_OT_cablerator_segment(bpy.types.Operator):
  ...
  def resolve_event_S(self, item):
    self.arr_mod.relative_offset_displace[2] = item['cur_value']
              ...
              if event.type == key:
                  if key == 'Q':
                    ...
                    if self.arr_mod:
                      ...
                      self.arr_mod.use_relative_offset = True
                      self.arr_mod.use_constant_offset = False
                      self.arr_mod.relative_offset_displace[0] = 0
                      self.arr_mod.relative_offset_displace[1] = 0
                      self.arr_mod.relative_offset_displace[2] = 1
                      ...
                      context.view_layer.objects.active = self.ob
                      self.events['S'] = {
                          'name': 'Offset Array Element (S)',
                          'status': False,
                          'cur_value': self.arr_mod.relative_offset_displace[2],
                          'type': 'float',
                          'show': True
                      }
                      self.events['C'] = {
          ...
          for key in self.events:
              if self.events[key]['status']:
                  ...
                  if key == 'D':
                      ...
                      self.arr_mod.relative_offset_displace[2] = self.events[key]['cur_value']
                  elif key == 'C':
