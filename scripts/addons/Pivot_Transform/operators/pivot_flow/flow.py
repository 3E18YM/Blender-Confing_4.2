...
class PIVOT_GGT_flow(GizmoGroup):
    ...
    def setup(self, context):
        ...
        self.preselect.use_tooltip = True
...
class PIVOT_GGT_flow_xform(GizmoGroup):
    ...
    def setup(self, context):
        ...
        color_z = (0.0, 0.4, 1.0)
        selectColor = (0.11, 0.11, 0.12)
        elementsColor = (0.95, 0.95, 0.97)
    ...
    def draw_prepare(self, context):
        global XFORM_ACTIVE
        XFORM_ACTIVE = any(gizmo.is_highlight or gizmo.is_modal for gizmo in self.gizmos)
