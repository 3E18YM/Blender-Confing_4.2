...
def start_flow(context):
    ...
    if 'GIZMO_PRO' in context.preferences.addons.keys():
        GIZMO_PRO = context.scene.gizmopro_settings.show_gizmo
        context.scene.gizmopro_settings.show_gizmo = False
...
def exit_flow(context):
    ...
    if 'GIZMO_PRO' in context.preferences.addons.keys():
        context.scene.gizmopro_settings.show_gizmo = GIZMO_PRO
