...
def fbx_animations_do(scene_data, ref_id, f_start, f_end, start_zero, objects=None, force_keep=False):
    ...
    for sk_name in animdata_shapes:
        ...
        #print('shape_key_values', len(shape_key_values), len(real_currframes))
        #print(shape_key_values)
...
def save_single(operator, scene, depsgraph, filepath="",
    ...
    settings = FBXExportSettings(
        ...
        shape_keys_baked_data_dict, mesh_names_data_dict, export_action_only, bake_anim_force_startend_keying_sk#Auto-Rig Pro implant
    )
