...
class OBJECT_OT_PG_build_camera_rig(Operator):
...
def add_pg_dolly_crane_buttons(self, context):
    """Dolly and crane entries in the Add Object > Camera Menu"""
    if context.mode == 'OBJECT':
        self.layout.operator(
            OBJECT_OT_PG_build_camera_rig.bl_idname,
...
def register():
    ...
    bpy.types.VIEW3D_MT_camera_add.append(add_pg_dolly_crane_buttons)
...
def unregister():
    ...
    bpy.types.VIEW3D_MT_camera_add.remove(add_pg_dolly_crane_buttons)
