...
class PHOTOGRAPHER_OT_AddLensPreset(AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        'photographer.lens_shift_x',
        'photographer.aperture',
        'photographer.aperture_preset',
        'photographer.aperture_slider_enable',
        'photographer.use_dof',
        'photographer.opt_vignetting',
        'photographer.ov_scale',
        'photographer.ov_rotation',
        'photographer.opt_vignetting_tex',
        'photographer.bokeh',
        'photographer.bokeh_brightness',
        'photographer.bokeh_saturation',
        'photographer.bokeh_rotation',
        'photographer.bokeh_tex',
        'camera.dof.focus_distance',
        'photographer.focus_plane_color',
        'photographer.focus_plane_edge',
        'photographer.dof_limits',
...
class PHOTOGRAPHER_OT_AddLensEffectsPreset(AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        'post_effects.bloom_amount',
        'post_effects.bloom_smoothness',
        'post_effects.bloom_maximum',
        'post_effects.bloom_quality',
        'post_effects.bloom_threshold',
        'post_effects.bloom_size',
        'post_effects.bloom_glare_size',
        'post_effects.bloom_stretch_ratio',
        'post_effects.bloom_tint',
        'post_effects.bloom_saturation',
        ...
        'post_effects.film_grain_displace',
        'post_effects.film_grain_tex',
        'post_effects.film_grain_animated',
    ]
...
class PHOTOGRAPHER_OT_AddExposurePreset(AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        'photographer.colorchart_enabled',
    ]
