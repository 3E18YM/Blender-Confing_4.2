...
class FlipFluidPresetRestoreDefault(bpy.types.Operator):
    ...
    bl_label = _z("Restore Default Settings")
    bl_description = "Restore Default Settings\nRestore domain settings to default values"
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, _z("Successfully restored default settings"))
...
class FlipFluidPresetSaveUserDefault(bpy.types.Operator):
    ...
    bl_label = _z("Save Default Settings")
    bl_description = "Save Default Settings\nSave the current domain settings as defaults"
    ...
    def execute(self, context):
        ...
        if not success:
            self.report({'ERROR'}, _z("Error saving user default settings"))

        self.report({'INFO'}, _z("Successfully saved default settings"))
        return {'FINISHED'}
...
class FlipFluidPresetRestoreSystemDefault(bpy.types.Operator):
    ...
    bl_label = _z("Restore Original Default Settings")
    bl_description = "Restore Original Default Settings\nRestore default domain settings to original system values"
    ...
    def execute(self, context):
        ...
        if not success:
            self.report({'ERROR'}, _z("Error restoring system default settings"))
...
class FlipFluidPresetCreateNewPackage(bpy.types.Operator):
    ...
    bl_label = _z("Create New Package")
    bl_description = "Create New Package\nCreate a new preset package"
    ...
    def draw(self, context):
        ...
        column.prop(settings, 'name', text=_z("Name"))
        column.prop(settings, 'author', text=_z("Author"))
        column.prop(settings, 'description', text=_z("Description"))
        column.prop(settings, 'use_custom_icons', text=_z("Use Custom Icons"))
        column.separator()
    ...
    def execute(self, context):
        ...
        if not settings.name:
            errmsg = _z("Error: New package must have a name")
        ...
        if error:
            errmsg = _z("Error: Unable to create new preset")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
        ...
        self.report({'INFO'}, _z("Successfully created package <{}>").format(settings.name))
        settings.reset()
        return {'FINISHED'}
...
class FlipFluidPresetDeletePackage(bpy.types.Operator):
    ...
    def draw(self, context):
        ...
        column = self.layout.column()
        column.separator()
        column.label(text=_z("Select Package:"))
        column.prop(settings, 'package', text="")
        column.separator()
        column.label(text=_z("Are you sure? This action cannot be undone."))
    ...
    def execute(self, context):
        ...
        if settings.package == 'DELETE_PACKAGE_NONE':
            errmsg = _z("Error: No package was selected for removal")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if error:
            errmsg = _z("Error: Unable to remove package")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    error_description=error,
        ...
        self.report({'INFO'}, _z("Successfully deleted package <{}>").format(name))
        return {'FINISHED'}
...
class FlipFluidPresetCreateNewPresetEnableAll(bpy.types.Operator):
    ...
    bl_label = _z("Enable All")
    bl_description = "Enable All\nEnable all preset attributes"
...
class FlipFluidPresetCreateNewPresetDisableAll(bpy.types.Operator):
    ...
    bl_label = _z("Disable All")
    bl_description = "Disable All\nDisable all preset attributes"
...
class FlipFluidPresetCreateNewPresetSelectPrevious(bpy.types.Operator):
    ...
    bl_label = _z("Previous")
    bl_description = "Previous\nSelect previous display panel"
...
class FlipFluidPresetCreateNewPresetReset(bpy.types.Operator):
    ...
    bl_label = _z("Reset Menu")
    bl_description = "Reset Menu\nReset menu settings"
...
class FlipFluidPresetCreateNewPreset(bpy.types.Operator):
    ...
    bl_label = _z("Create New Preset")
    bl_description = "Create New Preset\nCreate new preset based on the current domain settings"
    ...
    def draw_custom_properties(self, context, base_column):
        ...
        column = split.column()
        column.label(text=_z("Customize Preset Attributes:"))
        column.box()
        column.separator()
        column = split.column()
        ...
        if settings.current_display_panel != 'NONE':
            ...
            column.label(text=_z("No panels selected for export..."))
            return
    ...
    def draw(self, context):
        ...
        name_column_left.label(text=_z("Package: "))
        name_column_left.separator()
        name_column_left.separator()
        name_column_left.label(text=_z("Name: "))
        name_column_left.label(text=_z("Description: "))
        name_column_left.label(text=_z("Icon: "))
        ...
        if package_info["use_custom_icons"]:
            ...
            name_column_right.label(text=_z("(Custom icons are not enabled for this package)"))

        split = vcu.ui_split(export_column, factor=0.95)
        export_column = split.column()
        export_column.label(text=_z("Export Panel Settings:"))
        export_column.box()
    ...
    def execute(self, context):
        ...
        if not settings.name:
            errmsg = _z("Error: New preset must have a name")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if not exported_props:
            errmsg = _z("Error: Preset has no settings selected for export")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        self.report({'INFO'}, _z("Successfully created preset <{}>").format(settings.name))
        settings.reset()
        return {'FINISHED'}
...
class FlipFluidPresetSelectNext(bpy.types.Operator):
    ...
    bl_label = _z("Next")
    bl_description = "Next\nSelect the next package preset"
...
class FlipFluidPresetSelectPrevious(bpy.types.Operator):
    ...
    bl_label = _z("Previous")
    bl_description = "Previous\nSelect the previous package preset"
...
class FlipFluidPresetDeletePreset(bpy.types.Operator):
    ...
    def draw(self, context):
        ...
        column = self.layout.column()
        column.separator()
        column.label(text=_z("Package:"))
        column.prop(settings, 'package', text="")
        column.separator()
        column.label(text=_z("Preset:"))
    ...
    def execute(self, context):
        ...
        if settings.preset == 'DELETE_PRESET_NONE':
            errmsg = _z("Error: No preset was selected for removal")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if error:
            errmsg = _z("Error: Unable to remove preset")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    error_description=error,
        ...
        self.report({'INFO'}, _z("Successfully deleted preset <{}>").format(name))
        return {'FINISHED'}
...
class FlipFluidPresetDisplayInfo(bpy.types.Operator):
    ...
    bl_label = _z("Preset Info")
    bl_description = "Preset Info\nDisplay preset information"
    ...
    def draw(self, context):
        ...
        name_column_left.label(text=_z("Preset: "))
        name_column_left.separator()
        name_column_left.label(text=_z("Package: "))
        name_column_left.separator()
        name_column_left.label(text=_z("Description: "))
...
class FlipFluidPresetExportPackage(bpy.types.Operator):
    ...
    bl_label = _z("Export Package")
    bl_description = ("Export Package\nExport preset package as a .zip file. A menu will be"
    ...
    def draw(self, context):
        ...
        column = self.layout.column()
        column.separator()
        column.label(text=_z("Package will be exported to:"))
    ...
    def execute(self, context):
        ...
        if settings.package == 'EXPORT_PACKAGE_NONE':
            errmsg = _z("Error: No package was selected for export")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if error:
            errmsg = _z("Error: Unable to export package")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    error_description=error,
        ...
        settings.reset()
        self.report({'INFO'}, _z("Successfully exported package to <{}>").format(filepath))
        return {'FINISHED'}
...
class SelectPresetPackageZipFile(bpy.types.Operator, ImportHelper):
    ...
    bl_label = _z("Select Package Zipfile")
    bl_description = "Select Package Zipfile"
...
class FlipFluidPresetImportPackage(bpy.types.Operator):
    ...
    def draw_preset_properties(self, context, base_column):
        ...
        if settings.current_display_panel != 'NONE':
            row = column.row(align=True)
            column.separator()
            column.label(text=_z("Preset Attributes:"))
            row = column.row(align=True)
            row.alignment = 'LEFT'
    ...
    def draw(self, context):
        ...
        row = name_column1.row()
        row.label(text=_z("Package Info"))
        name_column1.box()
        name_column1.separator()
        ...
        package_info_left.label(text=_z("Package:"))
        ...
        if settings.package_info.author:
            ...
            split_column = vcu.ui_split(row, factor=0.1)
            package_info_left = split_column.column()
            package_info_left.label(text=_z("Author:"))
            package_info_right = split_column.column()
        ...
        if settings.package_info.description:
            ...
            split_column = vcu.ui_split(row, factor=0.1)
            package_info_left = split_column.column()
            package_info_left.label(text=_z("Description:"))
            package_info_right = split_column.column()
        ...
        split_column = vcu.ui_split(row, factor=0.1)
        package_info_left = split_column.column()
        package_info_left.label(text=_z("Presets:"))
        package_info_right = split_column.column()
        ...
        if settings.selected_preset == 'PRESET_NONE':
            name_column1.label(text=_z("This package does not contain any presets..."))
            return
    ...
    def execute(self, context):
        ...
        if error:
            errmsg = _z("Error: Unable to import package")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    error_description=error,
        ...
        settings.reset()
        self.report({'INFO'}, _z("Successfully imported package <{}>").format(pinfo['name']))
...
class FlipFluidPresetAddPresetToStack(bpy.types.Operator):
    ...
    bl_label = _z("Add to Preset Stack")
    bl_description = "Add to Preset Stack\nAdd selected preset to the preset stack"
...
class FlipFluidPresetRemovePresetFromStack(bpy.types.Operator):
    ...
    bl_label = _z("Remove From Preset Stack")
    bl_description = "Remove From Preset Stack\nRemove from preset stack"
...
class FlipFluidPresetMovePresetDownInStack(bpy.types.Operator):
    ...
    bl_label = _z("Move Down")
    bl_description = "Move Down\nMove preset down in the stack"
...
class FlipFluidPresetApplyAndRemoveFromStack(bpy.types.Operator):
    ...
    bl_label = _z("Apply")
    bl_description = "Apply\nApply preset and remove from the stack"
...
class FlipFluidPresetEditPresetReset(bpy.types.Operator):
    ...
    bl_label = _z("Reset Preset Edits")
    bl_description = "Reset Preset Edits\nReset preset edits to original values"
...
class FlipFluidPresetEditPreset(bpy.types.Operator):
    ...
    bl_label = _z("Edit Preset")
    bl_description = "Edit Preset\nEdit preset settings"
    ...
    def draw_custom_properties(self, context, base_column):
        ...
        split = vcu.ui_split(base_column, factor=1/6)
        column = split.column()
        column.label(text=_z("Edit Preset Attributes:"))
        column.box()
        column.separator()
        column = split.column()
    ...
    def draw(self, context):
        ...
        if settings.edit_preset == 'PRESET_NONE':
            name_column1.label(text=_z("No preset selected to edit..."))
            return

        row = name_column1.row()
        row.label(text=_z("Edit Preset Info:"))
        row = row.row()
        row.alignment = "RIGHT"
        ...
        name_column_left.label(text=_z("New Package: "))
        name_column_left.separator()
        name_column_left.separator()
        name_column_left.label(text=_z("New Name: "))
        name_column_left.label(text=_z("New Description: "))
        name_column_left.label(text=_z("New Icon: "))
        ...
        split = vcu.ui_split(export_column, factor=0.95)
        export_column = split.column()
        export_column.label(text=_z("Edit Export Panel Settings:"))
        export_column.box()
        export_column.separator()
        export_column_split = export_column.split()
        export_column1 = export_column_split.column()
    ...
    def execute(self, context):
        ...
        settings = dprops.presets.edit_preset_settings
        if settings.edit_preset == 'PRESET_NONE':
            errmsg = _z("Error: No preset was selected for edit")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if not settings.name:
            errmsg = _z("Error: Edited preset must have a name")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        exported_props = settings.get_exported_ui_properties()
        if not exported_props:
            errmsg = _z("Error: Edited preset has no settings selected for export")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    popup_width=400
        ...
        if error:
            errmsg = _z("Error: Unable to edit preset")
            bpy.ops.flip_fluid_operators.display_error(
                    'INVOKE_DEFAULT',
                    error_message=errmsg,
                    error_description=error,
        ...
        msg = _z("Successfully edited preset <{}> -> <{}>").format(edit_preset_name, settings.name)
