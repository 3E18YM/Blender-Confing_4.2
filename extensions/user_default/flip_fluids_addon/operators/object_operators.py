...
class FlipFluidAdd(bpy.types.Operator):
    ...
    bl_label = _z("Add FLIP fluid object")
    bl_description = "Add FLIP fluid object\nAdd active object as FLIP Fluid"
    bl_options = {'REGISTER'}
...
class FlipFluidRemove(bpy.types.Operator):
    ...
    bl_label = _z("Remove FLIP fluid object")
    bl_description = "Remove FLIP fluid object\nRemove FLIP Fluid settings from Object"
    bl_options = {'REGISTER'}
