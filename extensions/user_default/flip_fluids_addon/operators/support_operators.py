...
class FlipFluidSupportPrintSystemInfo(bpy.types.Operator):
    ...
    bl_label = _z("Print System & Blend Info")
    bl_description = "Print System & Blend Info\nPrint system and Blend file info if saved into the file (requires domain)"
...
class FlipFluidSupportStandardizeBlendFile(bpy.types.Operator):
    ...
    bl_label = _z("Standardize Blend File")
    bl_description = "Standardize Blend File\nSet cache/render location relative, set simulation viewport to visible, set simulation viewport mesh display to final (requires domain)"
    ...
    def execute(self, context):
        ...
        if new_cache_directory != original_cache_directory:
            info_msg = _z("Changed cache directory <{}> -> <{}>").format(original_cache_directory, new_cache_directory)
...
class FlipFluidSupportDisplayOverlayStats(bpy.types.Operator):
    ...
    bl_label = _z("Display Overlay Stats")
    bl_description = "Display Overlay Stats\nEnable overlays and show geometry overlay stats in the 3D viewports"
...
class FlipFluidSupportSelectSimulationObjects(bpy.types.Operator):
    ...
    bl_label = _z("Select All Simulation Objects")
    bl_description = "Select All Simulation Objects\nSelect all objects related to the simulation. Notes: may not select all dependencies of a simulation object. Will not select hidden objects"
...
class FlipFluidSupportSelectHiddenSimulationObjects(bpy.types.Operator):
    ...
    bl_label = _z("Show and Select Hidden Simulation Objects")
    bl_description = "Show and Select Hidden Simulation Objects\nShow and select all objects related to the simulation that are currently hidden. Notes: may not select all dependencies of a simulation object"
...
class FlipFluidSupportPrintHiddenSimulationObjects(bpy.types.Operator):
    ...
    bl_label = _z("Print Hidden Simulation Objects")
    bl_description = "Print Hidden Simulation Objects\nPrint objects related to the simulation that are currently hidden to the system console. Notes: may not select all dependencies of a simulation object"
...
class FlipFluidSupportPrintInverseObstacles(bpy.types.Operator):
    ...
    bl_label = _z("Print Inverse Obstacles")
    bl_description = "Print Inverse Obstacles\nPrint all obstacles with the 'Inverse' option enabled to the system console."
...
class FlipFluidSupportSelectInverseObstacles(bpy.types.Operator):
    ...
    bl_label = _z("Select Inverse Obstacles")
    bl_description = "Select Inverse Obstacles\nSelect all obstacles with the 'Inverse' option enabled. Will not select hidden objects"
...
class FlipFluidSupportInvertSelection(bpy.types.Operator):
    ...
    bl_label = _z("Invert Selection")
    bl_description = "Invert Selection\nInverts selection of currently selected objects"
...
class FlipFluidSupportIncrementAndSaveFile(bpy.types.Operator):
    ...
    bl_label = _z("Increment Version and Save Blend File")
    bl_description = "Increment Version and Save Blend File\nIncrement Blend filename version and save file"
