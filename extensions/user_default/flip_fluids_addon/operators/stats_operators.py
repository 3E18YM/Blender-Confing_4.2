...
class FlipFluidRefreshStats(bpy.types.Operator):
    ...
    bl_label = _z("Refresh Stats")
    bl_description = "Refresh Stats\nRefresh and update the cache and frame stats"
    bl_options = {'REGISTER'}
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, _z("Cache and frame stats have been refreshed. Found (") + str(num_updated_frames) + _z(") new frames."))
        return {'FINISHED'}
