...
def __extract_static_mesh(object_name):
    ...
    if bobj_data is None:
        msg = _z("Error extracting mesh data. Exported object not found: <{}>").format(object_name)
        raise Exception(msg)
...
def __extract_transform_data(object_name, frameno):
    ...
    if matrix_coefficients is None:
        msg = _z("Error extracting mesh transforms. Exported object not found: <{}>").format(object_name)
        raise Exception(msg)
