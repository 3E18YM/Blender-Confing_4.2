...
def _draw_geometry_attributes_menu(self, context):
    ...
    row.label(text=_z("Fluid Particle Attributes:"))

    if pprops.geometry_attributes_expanded:
        if not vcu.is_blender_31():
            column = box.column(align=True)
            column.enabled = False
            column.label(text=_z("Geometry attribute features for fluid particles are only available in"), icon='ERROR')
        ...
        if pprops.velocity_attributes_expanded:
            ...
            column.prop(pprops, "enable_fluid_particle_velocity_vector_attribute", text=_z("Velocity Attributes"))
            column.prop(pprops, "enable_fluid_particle_speed_attribute", text=_z("Speed Attributes"))
            column.prop(pprops, "enable_fluid_particle_vorticity_vector_attribute", text=_z("Vorticity Attributes"))
            column.operator("flip_fluid_operators.helper_initialize_motion_blur")
        else:
            row = row.row(align=True)
            row.alignment = 'RIGHT'
            row.prop(pprops, "enable_fluid_particle_velocity_vector_attribute", text=_z("Velocity"))
            row.prop(pprops, "enable_fluid_particle_speed_attribute", text=_z("Speed"))
            row.prop(pprops, "enable_fluid_particle_vorticity_vector_attribute", text=_z("Vorticity"))
        ...
        if pprops.color_attributes_expanded:
            ...
            column_left.prop(pprops, "enable_fluid_particle_color_attribute", text=_z("Color Attributes"))
            ...
            row = row.row(align=True)
            row.alignment = 'RIGHT'
            row.prop(pprops, "enable_fluid_particle_color_attribute", text=_z("Color"))
            row = row.row(align=True)
            row.alignment = 'RIGHT'
            row.enabled = pprops.enable_fluid_particle_color_attribute
        ...
        if pprops.other_attributes_expanded:
            column = subbox.column(align=True)
            column.prop(pprops, "enable_fluid_particle_age_attribute", text=_z("Age Attributes"))
            row = column.row(align=True)
            row.prop(pprops, "enable_fluid_particle_lifetime_attribute", text=_z("Lifetime Attributes"))
            row.prop(sprops, "lifetime_attribute_death_time")
            column.prop(pprops, "enable_fluid_particle_whitewater_proximity_attribute", text=_z("Whitewater Proximity Attributes"))
            column.prop(pprops, "enable_fluid_particle_source_id_attribute", text=_z("Source ID Attributes"))
        else:
            row = row.row(align=True)
            row.alignment = 'RIGHT'
            row.prop(pprops, "enable_fluid_particle_age_attribute", text=_z("Age"))
            row.prop(pprops, "enable_fluid_particle_lifetime_attribute", text=_z("Life"))
            row.prop(pprops, "enable_fluid_particle_whitewater_proximity_attribute", text=_z("WW Prox."))
            row.prop(pprops, "enable_fluid_particle_source_id_attribute", text=_z("Source ID"))
...
class FLIPFLUID_PT_DomainTypeFluidParticlesPanel(bpy.types.Panel):
    ...
    bl_label = _z("FLIP Fluid Particles")
    bl_description = "FLIP Fluid Particles"
    ...
    def draw(self, context):
        ...
        row.label(text=_z("Fluid Particle Export:"))
        ...
        if pprops.fluid_particles_expanded:
            ...
            subcolumn.separator()
            subcolumn.prop(pprops, "fluid_particle_source_id_blacklist", text=_z("Skip Particles With Source ID Value"))
        ...
        row.label(text=_z("Fluid Particle Generation:"))
