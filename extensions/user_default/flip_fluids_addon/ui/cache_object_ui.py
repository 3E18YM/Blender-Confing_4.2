...
class FLIPFLUID_PT_CacheObjectTypePanel(bpy.types.Panel):
    ...
    bl_label = _z("FLIP Fluid Mesh Display")
    bl_description = "FLIP Fluid Mesh Display"
    ...
    def draw_fluid_particle_viewport_render_display(self):
        ...
        column_left.label(text=_z("Final Display Settings:"))
        ...
        column_right.label(text=_z("Preview Display Settings:"))
        ...
        box = self.layout.box()
        column = box.column(align=True)
        column.label(text=_z("Particle Object Settings:"))
        column.separator()
    ...
    def draw_whitewater_particle_object_settings(self, prop_str, material_prop):
        ...
        box = self.layout.box()
        box.label(text=_z("Particle Display Settings:"))
        column = box.column(align=True)
        column.separator()
        ...
        box = self.layout.box()
        box.label(text=_z("Material Library"))
    ...
    def draw_surface(self, cache_props, domain_props):
        ...
        column.label(text=_z("Fluid Surface"))
        column.separator()
    ...
    def draw_fluid_particles(self, cache_props, domain_props):
        ...
        box = self.layout.box()
        box.label(text=_z("Material Library"))
        box.prop(dprops.materials, "fluid_particles_material", text=_z("Fluid Particles"))
        box.separator()
    ...
    def draw_foam(self, cache_props, domain_props):
        ...
        column = self.layout.column()
        column.label(text=_z("Whitewater Foam"))
        column.separator()
        ...
        column.operator("flip_fluid_operators.helper_delete_whitewater_objects", 
                        text=_z("Delete Whitewater Foam Mesh Objects"),
                        icon="X").whitewater_type = 'TYPE_FOAM'

        column.operator("flip_fluid_operators.helper_delete_whitewater_objects", 
                        text=_z("Delete All Whitewater Mesh Objects"),
    ...
    def draw_bubble(self, cache_props, domain_props):
        ...
        column = self.layout.column()
        column.label(text=_z("Whitewater Bubble"))
        column.separator()
        ...
        column = self.layout.column()
        column.operator("flip_fluid_operators.helper_delete_whitewater_objects", 
                        text=_z("Delete Whitewater Bubble Mesh Objects"),
    ...
    def draw_spray(self, cache_props, domain_props):
        ...
        column = self.layout.column()
        column.label(text=_z("Whitewater Spray"))
        column.separator()
        ...
        column = self.layout.column()
        column.operator("flip_fluid_operators.helper_delete_whitewater_objects", 
                        text=_z("Delete Whitewater Spray Mesh Objects"),
    ...
    def draw_dust(self, cache_props, domain_props):
        ...
        column = self.layout.column()
        column.label(text=_z("Whitewater Dust"))
        column.separator()
        ...
        column = self.layout.column()
        column.operator("flip_fluid_operators.helper_delete_whitewater_objects", 
                        text=_z("Delete Whitewater Dust Mesh Objects"),
