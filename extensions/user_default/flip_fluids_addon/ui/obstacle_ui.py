...
class FLIPFLUID_PT_ObstacleTypePanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if show_documentation:
            ...
            column.operator(
                "wm.url_open", 
                text=_z("How to debug issues with obstacle objects"), 
                icon="WORLD"
            ...
            column.operator(
                "wm.url_open", 
                text=_z("Using the Inverse option to perfectly contain fluid"), 
                icon="WORLD"
            ).url = "https://github.com/rlguy/Blender-FLIP-Fluids/wiki/Obstacle-Inverse-Workflow"
            column.operator(
                "wm.url_open", 
                text=_z("Liquid volume loss with animated obstacle"), 
                icon="WORLD"
        ...
        box = self.layout.box()
        box.label(text=_z("Obstacle Properties"))
