...
def draw_frame_info_simulation_stats(self, context, box):
    ...
    row.label(text=_z("Simulation Stats"))

    if sprops.frame_info_simulation_stats_expanded:
        column = subbox.column()
        split = column.split()
        column = split.column()
        column.label(text=_z("Frame ID:"))
        column.label(text=_z("Timeline Frame:"))
        column.label(text=_z("Timestep:"))
        column.label(text=_z("Substeps:"))
        column.label(text=_z("Fluid Particles:"))
        if sprops.display_frame_diffuse_particle_stats:
            column.label(text=_z("Whitewater Particles:"))
            column.label(text=_z("             Foam:"))
            column.label(text=_z("             Bubble:"))
            column.label(text=_z("             Spray:"))
            column.label(text=_z("             Dust:"))
        column.label(text=_z("Performance Score:"))
...
def draw_frame_info_solver_stats(self, context, box):
    ...
    row.label(text=_z("Solver Stats"))
    ...
    if sprops.frame_info_solver_stats_expanded:
        if sprops.frame_pressure_solver_enabled:
            ...
            row.label(text=_z("Pressure Solver"))
            ...
            if sprops.frame_info_pressure_solver_stats_expanded:
                ...
                column1.label(text=_z("Solver Status:"))
                column1.label(text=_z("Iterations:"))
                column1.label(text=_z("Estimated Error:"))
                row = column1.row(align=True)
                row.alert = sprops.frame_pressure_solver_stress.stress_level > stress_threshold
                row.label(text=_z("Stress Level:"))
        ...
        if sprops.frame_viscosity_solver_enabled:
            ...
            row.label(text=_z("Viscosity Solver"))
            ...
            if sprops.frame_info_viscosity_solver_stats_expanded:
                ...
                status_state = _z("Success")
                if not sprops.frame_viscosity_solver_success:
                    status_state = _z("FAILED")
...
def draw_frame_info_timing_stats(self, context, box):
    ...
    row.label(text=_z("Timing Stats"))

    if sprops.frame_info_timing_stats_expanded:
        column = subbox.column()
        split = vcu.ui_split(column, factor=0.75)
        column = split.column(align = True)
        column.prop(sprops.time_mesh, "pct", slider = True, text = _z("Mesh Generation"))
        column.prop(sprops.time_advection, "pct", slider = True, text = _z("Velocity Advection"))
        column.prop(sprops.time_particles, "pct", slider = True, text = _z("Fluid Particles"))
        column.prop(sprops.time_pressure, "pct", slider = True, text = _z("Pressure Solver"))
        if sprops.display_frame_diffuse_timing_stats:
            column.prop(sprops.time_diffuse, "pct", slider = True, text = _z("Whitewater Solver"))
        if sprops.display_frame_viscosity_timing_stats:
            column.prop(sprops.time_viscosity, "pct", slider = True, text = _z("Viscosity Solver"))
        column.prop(sprops.time_objects, "pct", slider = True, text = _z("Simulation Objects"))
        column.prop(sprops.time_other, "pct", slider = True, text = _z("Other"))
...
def draw_frame_info_mesh_stats(self, context, box):
    ...
    if sprops.frame_info_mesh_stats_expanded:
        ...
        column1.label(text="")
        column2.label(text=_z("Verts"))
        column3.label(text=_z("Faces"))
        column4.label(text=_z("Size"))

        total_bytes = 0
        if sprops.surface_mesh.enabled:
            column1.label(text=_z("Surface"))
        ...
        if sprops.surfaceblur_mesh.enabled:
            column1.label(text=_z("Motion Blur"))
        ...
        if sprops.surfacevelocity_mesh.enabled:
            column1.label(text=_z("Velocity"))
        ...
        if sprops.surfacevorticity_mesh.enabled:
            column1.label(text=_z("Vorticity"))
        ...
        if sprops.surfacelifetime_mesh.enabled:
            column1.label(text=_z("Lifetime"))
        ...
        if sprops.surfacewhitewaterproximity_mesh.enabled:
            column1.label(text=_z("Whitewater Proximity"))
        ...
        if sprops.surfacesourceid_mesh.enabled:
            column1.label(text=_z("Source ID"))
        ...
        if sprops.surfaceviscosity_mesh.enabled:
            column1.label(text=_z("Viscosity"))
        ...
        if sprops.foamblur_mesh.enabled:
            column1.label(text=_z("Foam Motion Blur"))
        ...
        if sprops.bubbleblur_mesh.enabled:
            column1.label(text=_z("Bubble Motion Blur"))
        ...
        if sprops.sprayblur_mesh.enabled:
            column1.label(text=_z("Spray Motion Blur"))
        ...
        if sprops.dustblur_mesh.enabled:
            column1.label(text=_z("Dust Motion Blur"))
        ...
        if sprops.foamvelocity_mesh.enabled:
            column1.label(text=_z("Foam Velocity"))
        ...
        if sprops.bubblevelocity_mesh.enabled:
            column1.label(text=_z("Bubble Velocity"))
        ...
        if sprops.sprayvelocity_mesh.enabled:
            column1.label(text=_z("Spray Velocity"))
        ...
        if sprops.dustvelocity_mesh.enabled:
            column1.label(text=_z("Dust Velocity"))
        ...
        if sprops.bubbleid_mesh.enabled:
            column1.label(text=_z("Bubble ID"))
        ...
        if sprops.sprayid_mesh.enabled:
            column1.label(text=_z("Spray ID"))
        ...
        if sprops.foamlifetime_mesh.enabled:
            column1.label(text=_z("Foam Lifetime"))
        ...
        if sprops.bubblelifetime_mesh.enabled:
            column1.label(text=_z("Bubble Lifetime"))
        ...
        if sprops.spraylifetime_mesh.enabled:
            column1.label(text=_z("Spray Lifetime"))
        ...
        if sprops.dustlifetime_mesh.enabled:
            column1.label(text=_z("Dust Lifetime"))
        ...
        if sprops.fluid_particle_mesh.enabled:
            column1.label(text=_z("Fluid Particles"))
        ...
        if sprops.fluid_particle_id_mesh.enabled:
            column1.label(text=_z("Fluid Particles ID"))
        ...
        if sprops.fluid_particle_velocity_mesh.enabled:
            column1.label(text=_z("Fluid Particles Velocity"))
        ...
        if sprops.fluid_particle_speed_mesh.enabled:
            column1.label(text=_z("Fluid Particles Speed"))
        ...
        if sprops.fluid_particle_vorticity_mesh.enabled:
            column1.label(text=_z("Fluid Particles Vorticity"))
        ...
        if sprops.fluid_particle_color_mesh.enabled:
            column1.label(text=_z("Fluid Particles Color"))
        ...
        if sprops.fluid_particle_age_mesh.enabled:
            column1.label(text=_z("Fluid Particles Age"))
        ...
        if sprops.fluid_particle_lifetime_mesh.enabled:
            column1.label(text=_z("Fluid Particles Lifetime"))
        ...
        if sprops.fluid_particle_viscosity_mesh.enabled:
            column1.label(text=_z("Fluid Particles Viscosity"))
        ...
        if sprops.fluid_particle_whitewater_proximity_mesh.enabled:
            column1.label(text=_z("Fluid Particles Whitewater Proximity"))
        ...
        if sprops.fluid_particle_source_id_mesh.enabled:
            column1.label(text=_z("Fluid Particles Source ID"))
        ...
        if sprops.debug_particle_mesh.enabled:
            column1.label(text=_z("Debug Particles"))
        ...
        if sprops.obstacle_mesh.enabled:
            column1.label(text=_z("Obstacle"))
...
def draw_frame_info(self, context, box):
    ...
    if sprops.is_frame_info_available:
        ...
        box.label(text=_z("Data Not Available (frame {})").format(str(sprops.current_info_frame)), icon='ERROR')
...
def draw_cache_info_simulation_stats(self, context, box):
    ...
    if sprops.cache_info_simulation_stats_expanded:
        ...
        split = column.split()
        column = split.column()
        column.label(text=_z("Completed Frames:"))
        column.label(text=_z("Start Frame:"))
        column.label(text=_z("End Frame:"))
        column.label(text=_z("Average Performance Score:"))
        ...
        if dprops.bake.is_simulation_running:
            ...
            if sprops.is_estimated_time_remaining_available:
                column.label(text=_z("Estimated Time Remaining:"))
            else:
                column.label(text=_z("Calculating time remaining..."))
...
def draw_cache_info_solver_stats(self, context, box):
    ...
    if sprops.pressure_solver_enabled:
        ...
        if sprops.cache_info_pressure_solver_stats_expanded:
            ...
            column_left.label(text=_z("Solver Failures:"))
            column_left.label(text=_z("Max Iterations:"))
            column_left.label(text=_z("Max Error:"))
            column_left.label(text=_z("Max Stress:"))

            failure_str =  "{} failures / {} steps".format(str(sprops.pressure_solver_failures), str(sprops.pressure_solver_steps))
            ...
            column_right.label(text=_z("(frame ") + str(sprops.pressure_solver_max_iterations_frame) + ")")
            column_right.label(text=_z("(frame ") + str(sprops.pressure_solver_max_error_frame) + ")")
            column_right.label(text=_z("(frame ") + str(sprops.pressure_solver_max_stress_frame) + ")")
    ...
    if sprops.viscosity_solver_enabled:
        ...
        if sprops.cache_info_viscosity_solver_stats_expanded:
            ...
            failure_str =  _z("{} failures / {} steps").format(str(sprops.viscosity_solver_failures), str(sprops.viscosity_solver_steps))
            ...
            column_right.label(text="")
            column_right.label(text=_z("(frame ") + str(sprops.viscosity_solver_max_iterations_frame) + ")")
            column_right.label(text=_z("(frame ") + str(sprops.viscosity_solver_max_error_frame) + ")")
            column_right.label(text=_z("(frame ") + str(sprops.viscosity_solver_max_stress_frame) + ")")
...
def draw_cache_info_mesh_stats(self, context, box):
    ...
    if sprops.cache_info_mesh_stats_expanded:
        ...
        if stats_exist:
            ...
            column2 = split.column()
            row = column2.row()
            row.label(text=_z("Total:    ") + format_bytes(total_size))
...
def draw_cache_info(self, context, box):
    ...
    if not sprops.is_cache_info_available:
        box.label(text=_z("Data Not Available"))
        return
...
class FLIPFLUID_PT_DomainTypeStatsPanel(bpy.types.Panel):
    ...
    bl_context = "physics"
    bl_category = _z("FLIP Fluid")
    bl_label = _z("FLIP Fluid Stats")
    bl_description = "FLIP Fluid Stats"
