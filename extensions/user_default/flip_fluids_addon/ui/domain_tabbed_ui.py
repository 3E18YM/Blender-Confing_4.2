...
class FLIPFLUID_PT_DomainTypeTabbedPanel(bpy.types.Panel):
    ...
    bl_label = _z("FLIP Fluid Domain")
    bl_description = "FLIP Fluid Domain"
    ...
    def draw(self, context):
        ...
        if   selected_panel == 'DOMAIN_SETTINGS_PANEL_SIMULATION':
            column.label(text=_z("FLIP Fluid Simulation"))
            ...
            column.label(text=_z("FLIP Fluid Particles"))
            ...
            column.label(text=_z("FLIP Fluid Surface"))
            ...
            column.label(text=_z("FLIP Fluid Whitewater"))
            ...
            column.label(text=_z("FLIP Fluid World"))
            ...
            column.label(text=_z("FLIP Fluid Materials"))
