...
class FLIPFLUID_PT_DomainTypeMaterialsPanel(bpy.types.Panel):
    ...
    bl_label = _z("FLIP Fluid Materials")
    bl_description = "FLIP Fluid Materials"
    ...
    def draw(self, context):
        ...
        column.prop(mprops, "surface_material", text=_z("Surface"))
        column.prop(mprops, "fluid_particles_material", text=_z("Fluid Particles"))
