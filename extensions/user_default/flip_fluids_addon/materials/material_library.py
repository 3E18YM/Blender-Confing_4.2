...
def __get_none_material_enum():
        return ("MATERIAL_NONE", _z("None"), "None", 0, 0)


def __get_all_materials_enum():
        return ("ALL_MATERIALS", _z("All Materials"), "Import all materials", 0, 0)
...
def register():
    bpy.types.Scene.flip_fluid_material_library = PointerProperty(
                name=_z("Flip Fluid Material Library"),
                description="Flip Fluid Material Library",
