...
def get_module_name():
    ...
    if module_name != hardcoded_name:
        errmsg = _z("Installation Error Detected")
        errdesc = _z("The FLIP Fluids addon directory located at <{}> must be named 'flip_fluids_addon'. Please rename this directory, restart Blender, and re-enable the addon.").format(module_dir)
