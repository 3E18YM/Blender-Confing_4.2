...
bl_info = {
    "name" : "FLIP Fluids",
    "description": "A FLIP Fluid Simulation Tool for Blender (v1.8.1 Release 16-JUL-2024)",
    "author" : "Ryan Guy & Dennis Fassbaender, iBlender@taobao.com",
    "version" : (1, 8, 1),
    "blender" : (3, 1, 0),
    "location" : "Properties > Physics > FLIP Fluid",
    "warning" : "",
    "wiki_url" : "https://github.com/rlguy/Blender-FLIP-Fluids/wiki",
    "doc_url" : "https://blendermarket.com/products/flipfluids",
    "tracker_url": "https://item.taobao.com/item.htm?ft=t&id=750550629513",
    "category" : "Animation"
}
...
class FlipFluidCompleteInstallation(bpy.types.Operator):
    ...
    bl_label = _z("Complete Installation")
    bl_description = "Complete Installation\nClick to complete the installation of the FLIP Fluids addon. Alternatively, restarting Blender or re-loading the Blend file will also complete the installation process"
