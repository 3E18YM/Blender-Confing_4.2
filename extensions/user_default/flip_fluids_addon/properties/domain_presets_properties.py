...
class DomainPresetsProperties(bpy.types.PropertyGroup):
    ...
    enable_presets = BoolProperty(
            ...
            description="Enable Presets\nEnable functionality to apply fluid presets",
            default=False,
    ...
    preview_preset = BoolProperty(
            name=_z("Preview"),
            description="Preview\nAutomatically assign preset on change (without"
    ...
    import_package_settings = PointerProperty(
            name=_z("Import Package Settings"),
            description="Import Package Settings",
            type=preset_properties.ImportPresetPackageSettings,
            ); exec(conv("import_package_settings"))
    preset_stack = PointerProperty(
            name=_z("Flip Fluid Preset Stack"),
            description="Flip Fluid Preset Stack",
