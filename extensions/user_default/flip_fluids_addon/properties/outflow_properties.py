...
class FlipFluidOutflowProperties(bpy.types.PropertyGroup):
    ...
    is_enabled = BoolProperty(
            name=_z("Enabled"),
            description="Enabled\nObject is active in the fluid simulation",
            default=True,
            ); exec(conv("is_enabled"))
    remove_fluid = BoolProperty(
            name=_z("Remove Fluid"),
            description="Remove Fluid\nEnable removing fluid particles from the domain",
            default=True,
            ); exec(conv("remove_fluid"))
    remove_whitewater = bpy.props.BoolProperty(
            name=_z("Remove Whitewater"),
            description="Remove Whitewater\nEnable removing whitewater particles from the domain",
            default=True,
            ); exec(conv("remove_whitewater"))
    is_inversed = BoolProperty(
            name=_z("Inverse"),
            description="Inverse\nTurn the outflow object 'inside-out'. If enabled,"
    ...
    disabled_in_viewport_tooltip = BoolProperty(
            ...
            description="Object Disabled in Viewport\nThis outflow object is currently disabled in the viewport within the"
