...
class FlipFluidForceFieldProperties(bpy.types.PropertyGroup):
    ...
    is_enabled = BoolProperty(
            name=_z("Enabled"),
            description="Enabled\nForce field is active in the fluid simulation",
            default=True,
            ); exec(conv("is_enabled"))
    strength = FloatProperty(
            name=_z("Strength"),
            description="Strength\nStrength of the force field. A negative value pulls fluid in,"
                " a positive value pushes fluid away",
            default=-9.81,
            precision=2,
            ); exec(conv("strength"))
    falloff_power = FloatProperty(
            name=_z("Falloff Power"),
            description="Falloff Power\nHow quickly force strength decreases with distance. If "
    ...
    enable_min_distance = BoolProperty(
            name=_z("Enable Min Distance"),
            description="Enable Min Distance\nUse a minimum distance for the force field falloff",
            default=False,
            ); exec(conv("enable_min_distance"))
    enable_max_distance = BoolProperty(
            name=_z("Enable Max Distance"),
            description="Enable Max Distance\nUse a maximum distance for the force field to work",
            default=False,
    ...
    maximum_force_limit_factor = FloatProperty(
            name=_z("Max Force Limit Factor"),
            description="Max Force Limit Factor\nThe maximum force in the field will be limited to the Strength"
    ...
    export_animated_mesh = bpy.props.BoolProperty(
            ...
            description="Export Animated Mesh\nExport this object as an animated mesh. Exporting animated meshes are"
    ...
    skip_reexport = BoolProperty(
            name=_z("Skip re-export"),
            description="Skip re-export\nSkip re-exporting this mesh when starting or resuming"
    ...
    force_reexport_on_next_bake = BoolProperty(
            name=_z("Force Re-Export On Next Bake"),
            description="Force Re-Export On Next Bake\nOverride the 'Skip Re-Export' option and force this mesh to be"
    ...
    maximum_strength_tooltip = BoolProperty(
            name=_z("Maximum Force"), 
            description="Maximum Force\nThis value estimates the maximum possible force field strength"
    ...
    falloff_shape = EnumProperty(
            name=_z("Falloff Shape"),
            description="Falloff Shape\n(Placeholder, TODO) Specifies the shape of the force field. Only takes"
    ...
    gravity_scale_point = FloatProperty(
            name=_z("Gravity Scale"),
            description="Gravity Scale\nScale the force of gravity around this point by this value. A scale"
    ...
    gravity_scale_width_point = FloatProperty(
            name=_z("Gravity Scale Width"),
            description="Gravity Scale Width\nThe distance around this point that gravity scaling will take effect",
            default=1.0,
    ...
    gravity_scale_surface = FloatProperty(
            name=_z("Gravity Scale"),
            description="Gravity Scale\nScale the force of gravity near the surface by this value. A scale"
                " of 0.0 is zero gravity, a scale of 1.0 is full gravity",
            default=1.0,
            soft_min=0.0, soft_max=1.0,
            precision=2,
    ...
    gravity_scale_width_surface = FloatProperty(
            name=_z("Gravity Scale Width"),
            description="Gravity Scale Width\nThe distance from the surface that gravity scaling will take effect",
            default=1.0,
            min=0.0, soft_max=5.0,
            precision=2,
    ...
    gravity_scale_volume = FloatProperty(
            name=_z("Gravity Scale"),
            description="Gravity Scale\nScale the force of gravity inside the volume by this value. A scale"
                " of 0.0 is zero gravity, a scale of 1.0 is full gravity",
            default=1.0,
            soft_min=0.0, soft_max=1.0,
            precision=2,
    ...
    gravity_scale_width_volume = FloatProperty(
            name=_z("Gravity Scale Width"),
            description="Gravity Scale Width\nThe distance from the outside of the volume's surface that gravity"
    ...
    flow_strength = FloatProperty(
            name=_z("Flow Strength"),
            description="Flow Strength\nStrength of the flow along the direction of the curve. The curve direction"
    ...
    spin_strength = FloatProperty(
            name=_z("Spin Strength"),
            description="Spin Strength\nStrength of the the force that directs fluid to spin around the curve. A positive"
    ...
    gravity_scale_curve = FloatProperty(
            name=_z("Gravity Scale"),
            description="Gravity Scale\nScale the force of gravity near the curve by this value. A scale"
                " of 0.0 is zero gravity, a scale of 1.0 is full gravity",
            default=1.0,
            soft_min=0.0, soft_max=1.0,
            precision=2,
    ...
    gravity_scale_width_curve = FloatProperty(
            name=_z("Gravity Scale Width"),
            description="Gravity Scale Width\nThe distance from the curve that gravity"
                " scaling will take effect",
            default=1.0,
            min=0.0, soft_max=5.0,
            precision=2,
    ...
    enable_endcaps = BoolProperty(
            name=_z("Enable End Caps"),
            description="Enable End Caps\nWhether fluid is attracted towards the ends of the curve segment. Disable"
    ...
    property_registry = PointerProperty(
            name=_z("Outflow Property Registry"),
            description="Outflow Property Registry",
            type=preset_properties.PresetRegistry,
            ); exec(conv("property_registry"))


    disabled_in_viewport_tooltip = BoolProperty(
            name=_z("Object Disabled in Viewport"), 
            description="Object Disabled in Viewport\nThis force field object is currently disabled in the viewport within the"
