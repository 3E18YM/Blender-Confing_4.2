...
class FlipFluidInflowProperties(bpy.types.PropertyGroup):
    ...
    is_enabled = BoolProperty(
            name=_z("Enabled"),
            description="Enabled\nInflow emits fluid into the domain. Tip: keyframe this option on/off to start and stop inflow emission",
            default=True,
            ); exec(conv("is_enabled"))
    substep_emissions = IntProperty(
            name=_z("Substep Emissions"),
            description="Substep Emissions\nNumber of times fluid is emitted from the inflow"
    ...
    append_object_velocity = BoolProperty(
            name=_z("Add Object Velocity to Infow"),
            description="Add Object Velocity to Infow\nAdd the velocity of the object to the inflow fluid"
                " velocity",
            default=False,
            ); exec(conv("append_object_velocity"))
    append_object_velocity_influence = FloatProperty(
            name=_z("Influence"),
            description="Influence\nAmount of velocity that is added to the inflow fluid."
    ...
    priority = IntProperty(
            name=_z("Priority"),
            description="Priority\nPriority that this fluid object is added to the simulation"
    ...
    inflow_velocity_mode = EnumProperty(
            name=_z("Velocity Mode"),
            description="Velocity Mode\nSet how the inflow fluid velocity is calculated",
    ...
    constrain_fluid_velocity = BoolProperty(
            name=_z("Constrain Fluid Velocity"),
    ...
    source_id = IntProperty(
            name=_z("Source ID Attribute"),
            description="Source ID Attribute\nAssign this identifier value to the fluid generated by this inflow. After"
    ...
    viscosity = FloatProperty(
            name=_z("Viscosity Attribute"),
            description="Viscosity Attribute\nAssign this viscosity value to the fluid generated by this object. After"
    ...
    lifetime = FloatProperty(
            name=_z("Lifetime Attribute"),
            description="Lifetime Attribute\nAssign this starting lifetime value to the fluid generated by this object."
    ...
    lifetime_variance = FloatProperty(
            name=_z("Lifetime Variance"),
            description="Lifetime Variance\nAdd or subtract a random value in seconds to the starting lifetime within the range of this variance value",
            min=0.0,
            default=0.0,
            ); exec(conv("lifetime_variance"))
    color = FloatVectorProperty(
            name=_z("Color Attribute"),
            description="Color Attribute\nAssign this color to the fluid generated by this object. After"
    ...
    property_registry = PointerProperty(
            name=_z("Inflow Property Registry"),
            description="Inflow Property Registry",
    ...
    disabled_in_viewport_tooltip = BoolProperty(
            ...
            description="Object Disabled in Viewport\nThis inflow object is currently disabled in the viewport within the"
