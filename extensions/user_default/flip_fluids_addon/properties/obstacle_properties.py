...
class FlipFluidObstacleProperties(bpy.types.PropertyGroup):
    ...
    is_enabled = BoolProperty(
            name=_z("Enabled"),
            description="Enabled\nObstacle is present in the fluid simulation",
            default=True,
            ); exec(conv("is_enabled"))
    is_inversed = BoolProperty(
            name=_z("Inverse"),
            description="Inverse\nTurn the obstacle 'inside-out'. Enabling this option will make the inside solid parts"
    ...
    skip_reexport = BoolProperty(
            name=_z("Skip Mesh Re-Export"),
            description="Skip Mesh Re-Export\nSkip re-exporting this mesh when starting or resuming"
    ...
    friction = FloatProperty(
            name=_z("Friction"),
            description="Friction\nAmount of friction between the fluid and the surface"
                " of the obstacle",
            min=0.0, max=1.0,
            default=0.0,
            precision=2,
    ...
    velocity_scale = FloatProperty(
            name=_z("Velocity Scale"),
            description="Velocity Scale\nScale the object velocity by this amount. Values greater than 1.0"
    ...
    whitewater_influence = FloatProperty(
            name=_z("Whitewater Influence"),
            description="Whitewater Influence\nScale the amount of whitewater generated near this"
    ...
    dust_emission_strength = FloatProperty(
            name=_z("Dust Emission Strength"),
            description="Dust Emission Strength\nScale the amount of whitewater dust particles generated"
    ...
    sheeting_strength = FloatProperty(
            name=_z("Sheeting Strength Multiplier"),
            description="Sheeting Strength Multiplier\nScale the amount of fluid sheeting strength against this"
    ...
    mesh_expansion = FloatProperty(
            name=_z("Expand Geometry"),
            description="Expand Geometry\nExpand the obstacle mesh by this value. This setting"
    ...
    property_registry = PointerProperty(
            name=_z("Obstacle Property Registry"),
            description="Obstacle Property Registry",
    ...
    disabled_in_viewport_tooltip = BoolProperty(
            ...
            description="Object Disabled in Viewport\nThis obstacle object is currently disabled in the viewport within the"
