...
class FlipFluidFluidProperties(bpy.types.PropertyGroup):
    ...
    append_object_velocity = BoolProperty(
            name=_z("Add Object Velocity to Fluid"),
            description="Add Object Velocity to Fluid\nAdd the velocity of the object to the initial velocity"
    ...
    append_object_velocity_influence = FloatProperty(
            name=_z("Influence"),
            description="Influence\nAmount of velocity that is added to the fluid."
    ...
    use_initial_velocity_target = BoolProperty(
            name =_z("Set towards target"),
            description="Set towards target\nSet initial velocity towards a target object",
            default=False,
            options={'HIDDEN'}
            ); exec(conv("use_initial_velocity_target"))
    fluid_velocity_mode = EnumProperty(
            name=_z("Velocity Mode"),
            description="Velocity Mode\nSet how the inital fluid velocity is calculated",
    ...
    source_id = IntProperty(
            ...
            description="Source ID Attribute\nAssign this identifier value to the fluid generated by this object. After"
    ...
    frame_offset_type = EnumProperty(
            name=_z("Trigger Type"),
            description="Trigger Type\nWhen to trigger fluid object",
    ...
    property_registry = PointerProperty(
            name=_z("Fluid Property Registry"),
            description="Fluid Property Registry",
    ...
    disabled_in_viewport_tooltip = BoolProperty(
            ...
            description="Object Disabled in Viewport\nThis fluid object is currently disabled in the viewport within the"
