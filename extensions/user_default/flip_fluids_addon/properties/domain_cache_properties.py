...
class DomainCacheProperties(bpy.types.PropertyGroup):
    ...
    clear_cache_directory_logs = BoolProperty(
            name=_z("Clear log files"),
            description="Clear log files\nAlso delete log files when freeing cache directory",
            default=False,
            ); exec(conv("clear_cache_directory_logs"))
    clear_cache_directory_export = BoolProperty(
            name=_z("Clear export files"),
            description="Clear export files\nAlso delete exported settings and objects when freeing cache directory",
            default=False,
