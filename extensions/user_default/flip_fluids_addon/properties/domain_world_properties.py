...
class DomainWorldProperties(bpy.types.PropertyGroup):
    ...
    world_scale_mode = EnumProperty(
            name=_z("World Scaling Mode"),
            description="World Scaling Mode\nScaling mode for the physical size of the domain",
    ...
    world_scale_relative = FloatProperty(
            name=_z("Meters"), 
            description="Meters\nSize of a Blender unit in meters. If set to 1.0, each blender unit will be equal to 1.0 meter in the simulation", 
            min=0.0001,
            default=1.0,
            precision=3,
    ...
    world_scale_absolute = FloatProperty(
            name=_z("Meters"), 
            description="Meters\nSize of the longest side of the domain in meters", 
            min=0.001,
            default=10.0,
            precision=3,
    ...
    force_field_resolution = EnumProperty(
            name=_z("Force Field Resolution"),
            description="Force Field Resolution\nAmount of grid resolution to use when evaluating force fields."
    ...
    force_field_weight_fluid_particles = FloatProperty(
            ...
            description="Fluid Particles\nForce field object weight for fluid particles", 
            soft_min=0.0,
            soft_max=1.0,
            default=1.0,
            precision=3,
    ...
    force_field_weight_whitewater_foam = FloatProperty(
            name=_z("Whitewater Foam"), 
            description="Whitewater Foam\nForce field object weight for whitewater foam particles. Note: This setting"
    ...
    force_field_weight_whitewater_bubble = FloatProperty(
            name=_z("Whitewater Bubble"), 
            description="Whitewater Bubble\nForce field object weight for whitewater bubble particles. Note: Bubble particles"
    ...
    force_field_weight_whitewater_spray = FloatProperty(
            name=_z("Whitewater Spray"), 
            description="Whitewater Spray\nForce field object weight for whitewater spray particles. Tip: Spray particles are"
    ...
    force_field_weight_whitewater_dust = FloatProperty(
            name=_z("Whitewater Dust"), 
            description="Whitewater Dust\nForce field object weight for whitewater dust particles", 
            soft_min=0.0,
            soft_max=1.0,
            default=1.0,
            precision=3,
    ...
    force_field_resolution_tooltip = BoolProperty(
            name=_z("Force Field Grid Resolution"), 
            description="Force Field Grid Resolution\nExact force field grid resolution calculated from the domain"
    ...
    enable_viscosity = BoolProperty(
            name=_z("Enable Viscosity"),
            description="Enable Viscosity\nEnable viscosity solver",
            default=False,
            ); exec(conv("enable_viscosity"))
    viscosity = FloatProperty(
            name=_z("Viscosity"), 
            description="Viscosity\nViscosity base value. This value is multipled by 10 to the"
                " power of (exponent * -1)", 
            min=0.0,
            default=5.0,
            precision=3,
    ...
    viscosity_exponent = IntProperty(
            name=_z("Viscosity Exponent"), 
            description="Viscosity Exponent\nViscosity exponent. Negative exponent for the viscosity value"
    ...
    enable_surface_tension = BoolProperty(
            name=_z("Enable Surface Tension"),
            description="Enable Surface Tension\nEnable surface tension forces",
            default=False,
            ); exec(conv("enable_surface_tension"))
    surface_tension = FloatProperty(
            name=_z("Surface Tension"), 
            description="Surface Tension\nSurface tension base value. This value is multipled by 10 to the"
                " power of (exponent * -1)", 
            min=0.0,
            default=0.25,
            precision=3,
    ...
    surface_tension_exponent = IntProperty(
            name=_z("Viscosity Exponent"), 
            description="Viscosity Exponent\nViscosity exponent. Negative exponent for the surface tension value"
                " to simplify entering small values (ex: 5.0 * 10^-3 = 0.005)", 
            min=0,
            soft_max=4, max=8,
            default=0,
    ...
    surface_tension_accuracy = IntProperty(
            name=_z("Surface Tension Accuracy"), 
            description="Surface Tension Accuracy\nAmount of accuracy when calculating surface tension."
    ...
    surface_tension_solver_method = EnumProperty(
            name=_z("Surface Tension Solver"),
            description="Surface Tension Solver\nSurface tension solving method to use",
    ...
    enable_sheet_seeding = BoolProperty(
            name=_z("Enable Sheeting Effects"),
            description="Enable Sheeting Effects\nFluid sheeting fills in gaps between fluid particles to"
    ...
    sheet_fill_rate = FloatProperty(
            name=_z("Sheeting Strength"), 
            description="Sheeting Strength\nThe rate at which new sheeting particles are added."
    ...
    sheet_fill_threshold = FloatProperty(
            name=_z("Sheeting Thickness"), 
            description="Sheeting Thickness\nControls how thick to fill in gaps", 
            min=0.0, max=1.0,
            soft_min=0.05,
            default=0.1,
            precision=2,
    ...
    boundary_friction = FloatProperty(
            name=_z("Boundary Friction"), 
            description="Boundary Friction\nAmount of friction on the domain boundary walls", 
            min=0.0,
            max=1.0,
            default=0.0,
            precision=2,
    ...
    surface_tension_substeps_tooltip = BoolProperty(
            name=_z("Estimated Substeps"), 
            description="Estimated Substeps\nThe estimated number of substeps per frame that the"
    ...
    def register_preset_properties(self, registry, path):
        ...
        add(path + ".world_scale_mode",                 _z("World Scaling Mode"),        group_id=0)
        add(path + ".world_scale_relative",             _z("Relative Scale"),            group_id=0)
        add(path + ".world_scale_absolute",             _z("Absolute Scale"),            group_id=0)
        add(path + ".gravity_type",                     _z("Gravity Type"),              group_id=0)
        add(path + ".gravity",                          _z("Gravity"),                   group_id=0)
        add(path + ".force_field_resolution",           _z("Force Field Resolution"),    group_id=0)
        add(path + ".force_field_weight_fluid_particles",   _z("Force Field Weight Fluid"),  group_id=0)
        add(path + ".force_field_weight_whitewater_foam",   _z("Force Field Weight Foam"),   group_id=0)
        add(path + ".force_field_weight_whitewater_bubble", _z("Force Field Weight Bubble"), group_id=0)
        add(path + ".force_field_weight_whitewater_spray",  _z("Force Field Weight Spray"),  group_id=0)
        add(path + ".force_field_weight_whitewater_dust",   _z("Force Field Weight Dust"),   group_id=0)
        add(path + ".enable_viscosity",                 _z("Enable Viscosity"),          group_id=0)
        add(path + ".viscosity",                        _z("Viscosity Base"),            group_id=0)
        add(path + ".viscosity_exponent",               _z("Viscosity Exponent"),        group_id=0)
        add(path + ".viscosity_solver_error_tolerance", _z("Viscosity Accuracy"),        group_id=0)
        add(path + ".enable_surface_tension",           _z("Enable Surface Tension"),    group_id=0)
        add(path + ".surface_tension",                  _z("Surface Tension"),           group_id=0)
        add(path + ".surface_tension_exponent",         _z("Surface Tension Exponent"),  group_id=0)
        add(path + ".surface_tension_accuracy",         _z("Surface Tension Accuracy"),  group_id=0)
        add(path + ".surface_tension_solver_method",    _z("Surface Tension Solver"),    group_id=0)
        add(path + ".enable_sheet_seeding",             _z("Enable Sheeting Effects"),   group_id=0)
        add(path + ".sheet_fill_rate",                  _z("Sheeting Strength"),         group_id=0)
        add(path + ".sheet_fill_threshold",             _z("Sheeting Thickness"),        group_id=0)
        add(path + ".boundary_friction",                _z("Boundary Friction"),         group_id=0)
