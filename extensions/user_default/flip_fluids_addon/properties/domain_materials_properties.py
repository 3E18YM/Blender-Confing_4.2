...
class DomainMaterialsProperties(bpy.types.PropertyGroup):
    ...
    surface_material = EnumProperty(
            ...
            description="Fluid Surface\nSelect a material for the fluid surface. Tip: materials can also be"
    ...
    fluid_particles_material = EnumProperty(
            ...
            description="Fluid Particles\nSelect a material for the fluid particles. Tip: If the object contains"
    ...
    whitewater_foam_material = EnumProperty(
            ...
            description="Whitewater Foam\nSelect a material for the foam particles. Tip: materials can also be"
    ...
    whitewater_bubble_material = EnumProperty(
            ...
            description="Whitewater Bubble\nSelect a material for the bubble particles. Tip: materials can also be"
    ...
    whitewater_spray_material = EnumProperty(
            ...
            description="Whitewater Spray\nSelect a material for the spray particles. Tip: materials can also be"
    ...
    whitewater_dust_material = EnumProperty(
            ...
            description="Whitewater Dust\nSelect a material for the dust particles. Tip: materials can also be"
    ...
    material_import = EnumProperty(
            name=_z("Import"),
            description="Import\nImport materials into this scene",
    ...
    def register_preset_properties(self, registry, path):
        ...
        add(path + ".surface_material",           _z("Surface Material"), group_id=0)
        add(path + ".fluid_particles_material",   _z("Fluid Particles Material"), group_id=0)
        add(path + ".whitewater_foam_material",   _z("Foam Material"),    group_id=0)
        add(path + ".whitewater_bubble_material", _z("Bubble Material"),  group_id=0)
        add(path + ".whitewater_spray_material",  _z("Spray Material"),   group_id=0)
        add(path + ".whitewater_dust_material",   _z("Dust Material"),   group_id=0)
